...
| PDF Extraction - Reference Authors | 502 | Reference-section author strings, restricted to detected `REFERENCES` sections. |
| PDF Extraction - Author Index | 568 | Grouped author-name index from extracted citations and reference-section author strings. |
...
- PDF extraction audit indexes are broader than the curated exam index and include confidence/source columns so questionable rows can be reviewed before promotion.
