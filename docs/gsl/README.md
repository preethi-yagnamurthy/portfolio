...
| Index | Rows | What it is for |
| --- | ---: | --- |
| PDF Extraction - Classified Master | 12,377 | Relational master table containing all classified rows with source line/span IDs and confidence. |
| PDF Extraction - All Headings | 3,774 | Broad heading candidates detected from font size, font weight, numbering patterns, and module labels. |
| PDF Extraction - Section Headings | 3,208 | Section/subheading candidates from the calibrated PDF extraction pass. |
