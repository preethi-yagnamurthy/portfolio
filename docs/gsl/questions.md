...
This directory owns the private GSL study page at `docs/gsl/index.html`.

## Files

- `docs/gsl/index.html` is the dedicated GSL quiz page.
...
- `docs/gsl-console.html` is a direct-access redirect into the GSL page.
